\documentclass[smallcondensed,nospthms,english]{svjour3}     % onecolumn (ditto)
\smartqed
\usepackage{graphicx}
\usepackage{mathptmx}
...
\title{Property FW and wreath products of groups: a~simple approach using Schreier graphs\thanks{Supported by grant 200021\textunderscore188578 of the Swiss National Fund for Scientific Research.}
}
\author{Paul-Henry Leemann \and Grégoire Schneeberger* %etc.
}

\institute{Paul-Henry Leemann \at
             	Université de Neuchâtel, Institut de Mathématiques, Rue Emile-Argand 11, 2000 Neuchâtel, Suisse \\
              \email{Paul-Henry.Leemann@unine.ch } 
           \and
           Grégoire Schneeberger \at
           Université de Genève, Section de mathématiques, Rue du Conseil-Général 7-9, 1205 Genève, Suisse \\
...
\keywords{Wreath Products \and Property FW \and Schreier graphs \and Ends}
\subclass{20E22 \and 20F65}
\medskip
...
%\begin{data}
%Data sharing not applicable to this article as no datasets were generated or analysedduring the current study. 
%\end{data}
