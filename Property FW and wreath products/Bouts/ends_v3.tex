...
Yves Cornullier proved that a finitely generated wreath product $G\wr_XH$ has property FW if and only if both $G$ and $H$ have property FW and $X$ is finite. In this paper, we will present a more explicit combinatorial elementary proof using Schreier graphs. \GS{Ajouté que c'est déjà dans Cornullier}
\end{abstract}
%
%
%
