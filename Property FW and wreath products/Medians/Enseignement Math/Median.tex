...
Indeed by~\ref{} \todo{Est ce que c'est la référence du papier de Bergman ici ? Si oui la citation c'est MR2239037}
, symmetric groups over infinite sets are uncountable discrete group with Bergman's property which, as we will see just below, implies property~\FH.
...
The group $\SL_2(\Z[\sqrt{2}])$ has property~\FW{} but not \FH, \todo{Ok FA -> FH}see~\cite{MR3299841}.
