...
Let $G$ and $(G_x)_{x\in X}$ be non-trivial groups and let $H$ be a group acting on $X$. Then
\begin{enumerate}
...
Suppose that \BS{} implies having uncountable cofinality.
Let $G$ and $(G_x)_{x\in X}$ be non-trivial groups and let $H$ be a group acting on $X$. % \GS{Idem remarque ci-dessus pour $H$}Then
\begin{enumerate}
