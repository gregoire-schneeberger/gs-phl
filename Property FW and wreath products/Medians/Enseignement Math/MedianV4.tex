...
For the other implication, suppose that $G$ has uncountable cofinality but infinite abelianization $G/[G,G]$. The group $G/[G,G]$ being an infinite Abelian group, it has a countably infinite quotient $A$ that has uncountable cofinality, see Lemma~\ref{Lem:Quotient}. We conclude that $A$ is an infinite finitely generated Abelian group and therefore projects onto $\Z$.
