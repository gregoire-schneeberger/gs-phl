...
\end{defn}
For $g$ in $G$ and $x$ in $X$, we define the useful functions $\delta_x^g$ as \mycomment[GS]{On les utilise dans les dernières preuves.}
...
We have the following implications between the properties of Definition~\ref{Def:FHFA} \cite{MR1432323,MR0476875 ,MR3299841,2013arXiv1302.5982C}
...
By Proposition~\ref{Prop:WRFA} (more precisely Lemma~\ref{Lemma:Cof}), it is possible to get ride of the ``finitely many orbits'' hypothesis in Theorem~\ref{Thm:FACK} to obtain \mycomment[GS]{Il manque la suite}
