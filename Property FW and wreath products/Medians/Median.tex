...
Historically many of these properties were defined using the existence of fixed points, but in some cases this is equivalent.
...
As noted in the introduction, a group $G$ has property~\BS{} if and only any $G$ action on a \CatS-space has at least one bounded orbit.
