...
Indeed, while the map $d'$ might not satisfies the triangle inequality for a generic quotient $X/\sim$, this is the case if the quotient is by a subgroup of isometries; details are let to the reader.\PH{J'ai mis ça (ton texte en commentaire). À voir celui qui rend mieux en anglais.}
