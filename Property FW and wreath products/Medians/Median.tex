...
However,  by \cite{Cornulier2013,MR1663779} if a group $G$ acts on a connected median graph with a bounded orbit, then it has a finite orbit.\\[3ex]
...
\end{prop}
\begin{proof}
One direction is simply Lemma~\ref{Lemma:Quotient} and the definition of relative property~SB.
